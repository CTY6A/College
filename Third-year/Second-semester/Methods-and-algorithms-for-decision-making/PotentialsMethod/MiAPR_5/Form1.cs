    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            while (point.X < (pictureBox1.Width / (2 * SCALE_MODE)))
            {
                ...
                bufferedGraphics.Graphics.FillRectangle(new SolidBrush(Color.Green),
                    (int) (point.X * SCALE_MODE + pictureBox1.Width/2),
                    (int) (-point.Y * SCALE_MODE + pictureBox1.Height/2), 1, 1);
                point.X += EPS;
            }

            bufferedGraphics.Graphics.FillEllipse(new SolidBrush(Color.LightSkyBlue),
            ...
            bufferedGraphics.Graphics.FillEllipse(new SolidBrush(Color.Tomato),
