...
var
  ...
  i, CurCLI, MaxCLI, NumOfCase, NumOfElseIf, CL, CLsmall: Integer;
...
begin
  ...
  begin
    ...
    case Str[1] of
      ...
      'a'..'z', '_' : begin
                        ...
                        if (Word = 'andfor') or ('andwhile' = Word) or (Word = 'case') or ('else' = Word) or (Word = 'break') then
                        else
                          if (Word = 'and') or ('or' = Word) or (Word = 'xor') or ('continue' = Word) or ('return' = Word) or (Word = 'as') then
  ...
  SG3Lines.Cells[1,0]:='n='+inttostr(SGOperators.RowCount-1)+'+'+inttostr(SGOperands.RowCount-1)+'='+inttostr(SGOperators.RowCount-2+SGOperands.RowCount);
  ...
  SGOperands.Cells[0,SGOperands.RowCount-1]  := 'n2=' + inttostr(SGOperands.RowCount-1);
  SGOperators.Cells[0,SGOperators.RowCount-1] := 'n1=' + inttostr(SGOperators.RowCount-1);
